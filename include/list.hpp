...
private:
  ...
  bool find(Key key, find_info& info, detail::backoff& backoff);
};

template <class Key, class Reclaimer>
list<Key, Reclaimer>::~list()
{
...
template <class Key, class Reclaimer>
bool list<Key, Reclaimer>::find(Key key, find_info& info, detail::backoff& backoff)
{
retry:
  info.prev = &head;
...
template <class Key, class Reclaimer>
bool list<Key, Reclaimer>::search(Key key)
{
  find_info info;
...
template <class Key, class Reclaimer>
bool list<Key, Reclaimer>::insert(Key key)
{
...
template <class Key, class Reclaimer>
bool list<Key, Reclaimer>::remove(Key key)
{
  detail::backoff backoff;
  find_info info;
