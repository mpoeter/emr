...
#include "detail/perf_counter.hpp"
...
namespace emr {
  ...
  struct stamp_it::thread_control_block :
    detail::aligned_object<thread_control_block, 1 << MarkBits>,
  ...
  template <class T, class MarkedPtr>
  void stamp_it::guard_ptr<T, MarkedPtr>::acquire(concurrent_ptr<T>& p,
  ...
  SELECT_ANY emr::detail::allocation_tracker stamp_it::allocation_tracker;
