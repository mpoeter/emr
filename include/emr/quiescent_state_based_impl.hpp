...
namespace emr {
  ...
  template <class T, class MarkedPtr>
  void quiescent_state_based::guard_ptr<T, MarkedPtr>::acquire(concurrent_ptr<T>& p,
  ...
  SELECT_ANY emr::detail::allocation_tracker quiescent_state_based::allocation_tracker;
