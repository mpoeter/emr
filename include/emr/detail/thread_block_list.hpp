...
public:
  ...
  void abandon_retired_nodes(detail::deletable_object* obj)
  {
    auto last = obj;
    auto next = last->next;
    while (next)
  ...
  detail::deletable_object* adopt_abandoned_retired_nodes()
  {
...
private:
  ...
  alignas(64) std::atomic<detail::deletable_object*> abandoned_retired_nodes;
};
